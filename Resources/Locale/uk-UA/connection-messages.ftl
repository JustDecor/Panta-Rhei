...
generic-misconfigured = Сервер неправильно налаштований і не приймає гравців. Будь ласка, зв'яжіться з власником сервера та спробуйте ще раз пізніше.

ipintel-server-ratelimited = Цей сервер використовує систему перевірки з зовнішньою верифікацією, але сервер досяг максимальної кількості перевірок у зовнішньому сервісі. Будь ласка, повідомте про це адміністрацію сервера для подальшої допомоги або спробуйте ще раз пізніше.
ipintel-unknown = Цей сервер використовує систему перевірки з зовнішньою верифікацією, але під час перевірки вашого підключення сталася помилка. Будь ласка, повідомте про це адміністрацію сервера для подальшої допомоги або спробуйте ще раз пізніше.
ipintel-suspicious = Схоже, ви намагаєтеся підключитися через дата-центр, проксі, VPN або інше підозріле з'єднання. З адміністративних причин такі підключення не дозволені для гри. Якщо у вас увімкнено VPN або подібний сервіс, вимкніть його та спробуйте підключитися знову. Якщо ви вважаєте це помилкою або вам необхідно використовувати такі сервіси для гри, зверніться до адміністрації сервера для отримання допомоги.

hwid-required = Ваш клієнт відмовився надсилати ідентифікатор обладнання (HWID). Будь ласка, зверніться до адміністрації для отримання подальшої допомоги.
