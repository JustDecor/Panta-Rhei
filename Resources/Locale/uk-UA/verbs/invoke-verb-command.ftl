...
invoke-verb-command-invalid-player-entity = Вказаний UID гравця не відповідає дійсній сутності.
invoke-verb-command-invalid-target-entity = Вказаний UID цілі не відповідає дійсній сутності.

invoke-verb-command-success = Викликано дію «{ $verb }» для { $target }, використовуючи { $player } як виконавця.

invoke-verb-command-verb-not-found = Не вдалося знайти дію «{ $verb }» для { $target }.
