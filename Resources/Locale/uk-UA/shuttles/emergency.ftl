...
cmd-delayroundend-desc = Зупиняє таймер, що закінчує раунд, коли аварійний шатл покидає гіперпростір.
...
cmd-launchemergencyshuttle-desc = Ранній запуск аварійного шатлу, якщо це можливо.
...
emergency-shuttle-extended = {" "}Час запуску було продовжено через несприятливі обставини.
...
map-name-terminal = Термінал Arrivals
