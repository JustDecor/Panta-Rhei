...
store-ui-refund-text = Повернення коштів
...
store-ui-discount-display =  (Знижка {$amount}!)
store-ui-traitor-flavor = Авторське право (C) NT -30643
store-ui-traitor-warning = Оперативники повинні блокувати свої аплінки після використання, щоб уникнути виявлення.
...
store-preset-name-nukie-delivery = Блюспейс-доставка ЯОП
