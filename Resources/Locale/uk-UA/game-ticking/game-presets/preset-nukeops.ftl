...
nukeops-opsmajor = [color=crimson]Абсолютна перемога синдикату![/color]
...
nukeops-crewmajor = [color=green]Абсолютна перемога екіпажу![/color]
...
nukeops-cond-nukiesabandoned = Оперативники були полишені.
